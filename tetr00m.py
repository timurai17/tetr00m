...
bot = telebot.Telebot('7062345339:AAGRJJngmM_WHFkbBzgvmVenx7usHL-h0ro')
...
def start(message):
    ...
    markup.add(btn1)
    bot.send_message(message.from_user.id, "👋 Привет! Я бот по имени Тетрум!", reply_markup=markup)
